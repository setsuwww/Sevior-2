            ...
            <div className="bg-white border-b border-slate-200">
                <div className="max-w-[1600px] mx-auto p-6 lg:px-8 lg:py-10">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row gap-4">
                        ...
                        <Button
                            variant="outline"
                            className="h-12 px-6 border-slate-200 text-slate-700 bg-white hover:bg-slate-50 shadow-sm rounded-xl"
                        >
            ...
            <div className="max-w-[1600px] mx-auto p-6 lg:p-8">
                ...
                {loading ? (
                    <div className="py-20 text-center">
                        <div className="mx-auto w-8 h-8 border-4 border-slate-200 border-t-teal-500 rounded-full animate-spin" />
