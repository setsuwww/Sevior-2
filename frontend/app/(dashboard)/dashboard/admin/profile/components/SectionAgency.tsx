            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <div className="h-16 w-16 overflow-hidden rounded-full border border-gray-900 bg-slate-800">
                            {agencyImagePreview ? (
                                <img
                        ...
                        <button
                            ...
                            className="absolute -bottom-1 -right-1 rounded-full border-2 border-gray-50 bg-teal-600 p-1.5 shadow-sm transition-colors hover:bg-teal-700"
                        >
                    ...
                    <div>
                        ...
                        {agency.AgencySlug && (
                            <div className="mt-1 flex items-center gap-1 text-sm italic text-gray-500">
                ...
                <button
                    ...
                    className="flex items-center gap-2 rounded-sm border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-100"
                >
