    ...
    if (!token) {
        return (
            <div className="text-center py-8">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Invalid Token</h3>
    ...
    if (isSuccess) {
        return (
            <div className="flex flex-col items-center justify-center text-center space-y-4 py-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Password reset complete</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm max-w-[300px]">
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4 selection:bg-teal-500/30">
            <div className="w-full max-w-md">
                ...
                <Card className="shadow-xl border-gray-200/60 dark:border-gray-800">
