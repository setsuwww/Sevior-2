...
export default function RegisterSelectionPage() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-olive-50/50 dark:bg-olive-950 p-4 sm:p-6 lg:p-8 selection:bg-teal-500/30">
            {/* Back Navigation */}
            <div className="w-full max-w-4xl mx-auto mb-8 sm:mb-10">
                <Link
                    href="/"
                    className="inline-flex items-center text-sm font-medium text-olive-500 dark:text-olive-400 hover:text-olive-900 dark:hover:text-white transition-colors group focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-md p-1 -ml-1"
            ...
            <div className="text-center mb-12 flex flex-col items-center">
                ...
                <h1 className="text-3xl sm:text-4xl font-black text-olive-900 dark:text-white tracking-tight">Join Sevior.</h1>
                <p className="text-olive-500 dark:text-olive-400 mt-3 text-lg">Choose your account type to get started.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 max-w-4xl w-full mx-auto items-center">
                ...
                <Link href="/register/agency" className="group relative block w-full outline-none">
                    <div className="bg-gradient-to-r from-olive-900 to-teal-900 text-white rounded-3xl p-8 sm:p-10 lg:p-12 flex flex-col shadow-xl transition-all duration-300 md:group-hover:-translate-y-2 md:group-hover:shadow-2xl relative overflow-hidden border border-white/10 ring-2 ring-transparent group-focus:ring-teal-500">
                        ...
                        <div className="mt-4">
                            <button className="w-full bg-white text-olive-900 hover:bg-olive-50 font-bold py-4 px-8 rounded-xl transition-colors shadow-sm text-base flex items-center justify-center">
                ...
                <Link href="/register/client" className="group relative block w-full outline-none">
                    <div className="bg-white dark:bg-olive-900 border border-olive-400 dark:border-olive-800 rounded-r-3xl p-8 flex flex-col shadow-sm transition-all duration-300 md:group-hover:-translate-y-1 md:group-hover:shadow-md ring-2 ring-transparent group-focus:ring-blue-500">

                        <div className="w-14 h-14 bg-green-100 text-green-600 rounded-sm flex items-center justify-center mb-8">
                            <User className="w-7 h-7" />
                        </div>

                        <h2 className="text-2xl font-bold text-olive-900 dark:text-white mb-3 tracking-tight">Client</h2>
                        ...
                        <div className="space-y-3 my-8 flex-1">
                            {[
                                ...
                                <div key={i} className="flex items-center text-olive-600 dark:text-olive-400">
            ...
            <p className="mt-12 text-olive-500 dark:text-olive-400 font-medium">
                Already have an account? <Link href="/login" className="text-olive-900 hover:text-teal-600 font-bold hover:underline">Log In</Link>
            </p>
        </div>
    );
}
