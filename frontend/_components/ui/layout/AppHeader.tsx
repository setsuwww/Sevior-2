...
export default function AppHeader() {
    ...
    return (
        <header className="h-20 sticky top-0 bg-white/80 backdrop-blur-xl border-b border-gray-300 flex items-center justify-between px-6 z-30 transition-all duration-300">
            {/* Left side */}
            <div className="flex items-center">
                <Button
                    variant="ghost"
                    size="icon-sm"
                    className="mr-2 text-gray-500 hover:text-gray-900 hover:bg-gray-100"
