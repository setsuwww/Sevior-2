    ...
    return (
        <Link
            ...
            className={`flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group relative overflow-hidden ${isActive
                    ...
                    : "text-olive-600 hover:text-olive-900 hover:bg-olive-50 font-medium"
        ...
        >
            ...
            {Icon && (
                <Icon
                    className={`w-5 h-5 transition-colors ${isActive ? "text-teal-600" : "text-olive-400 group-hover:text-olive-600"
                        }`}
                />
            )}
