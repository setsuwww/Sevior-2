    ...
    return (
        <div className="group bg-white dark:bg-olive-900 rounded-2xl border border-olive-100 dark:border-olive-800 p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-1 relative">
            ...
            <div className="flex items-start gap-4 mb-5">
                <Avatar className="w-16 h-16 border-2 border-white dark:border-olive-800 shadow-sm bg-olive-50 dark:bg-olive-800">
                ...
                <div>
                    <h3 className="font-bold text-lg text-olive-900 dark:text-olive-100 leading-tight group-hover:text-teal-600 transition-colors">{client.companyName}</h3>
            ...
            <div className="space-y-2 mb-5">
                <div className="flex items-center text-sm text-olive-600 dark:text-olive-300 font-medium">
                    {client.contactName}
                </div>
            ...
            <p className="text-sm text-olive-600 dark:text-olive-400 mb-6 line-clamp-2 min-h-[40px] border-t border-olive-100 dark:border-olive-800 pt-4">
                {client.description || "No description provided."}
            </p>

            <div className="grid grid-cols-2 gap-4 bg-olive-50 dark:bg-olive-800/50 rounded-xl p-4 mt-auto">
                <div>
                    <div className="flex items-center text-olive-500 dark:text-olive-400 mb-1">
                    ...
                    <p className="font-semibold text-olive-900 dark:text-olive-100 text-lg">{client.totalProjects}</p>
                </div>
                <div>
                    <div className="flex items-center text-olive-500 dark:text-olive-400 mb-1">
                    ...
                    <p className="font-semibold text-olive-900 dark:text-olive-100 text-lg">{formatCurrency(client.revenue)}</p>
                </div>
            </div>
        </div>
    );
