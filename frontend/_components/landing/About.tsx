...
export function AboutCard({
  ...
  return (
    <div className="bg-white p-6 rounded-sm border border-slate-300 shadow-xs hover:scale-105 transition-all duration-200 cursor-pointer">
      <div
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="relative grid grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                <div className="bg-white p-6 rounded-sm border border-slate-300 shadow-xs hover:scale-105 transition-all duration-200 cursor-pointer">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">Give clients transparent access to their project's status.</p>
                </div>
          ...
          <div className="flex-1 lg:pl-10">
            ...
            <h3 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-6 leading-tight">
